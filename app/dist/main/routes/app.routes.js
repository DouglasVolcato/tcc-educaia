...
const aiGeneratedSuggestions = [
    {
        ...
        answer: "As mitocôndrias são responsáveis pela produção de ATP por meio da respiração celular, fornecendo energia para a célula.",
    },
    {
        question: "Como o efeito estufa influencia o clima terrestre?",
        answer: "O efeito estufa mantém a temperatura da Terra adequada à vida ao reter parte do calor irradiado pela superfície, evitando variações extremas.",
    },
    {
        question: "Quais são os principais biomas brasileiros?",
        answer: "Amazônia, Cerrado, Mata Atlântica, Caatinga, Pantanal e Pampa, cada um com características climáticas e biodiversidade próprias.",
    },
];
const reviewSession = {
    deckId: "enem-bio",
    ...
    cards: [
        ...
        },
        {
            ...
            answer: "O DNA possui dupla hélice, açúcar desoxirribose e timina. O RNA é fita simples, tem ribose e uracila no lugar da timina.",
        ...
        },
        {
            ...
            answer: "Processo em que organismos autotróficos convertem energia luminosa em energia química, produzindo glicose e oxigênio.",
